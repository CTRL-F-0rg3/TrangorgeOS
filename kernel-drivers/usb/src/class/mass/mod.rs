...
use crate::host::xhci::control;
use crate::host::xhci::init::Xhci;
use crate::host::xhci::ring::TransferRing;
use crate::host::xhci::trb::*;
...
/// Borrow the attached mass-storage device (implements [`blockdev::BlockDevice`]).
pub fn mass0() -> Option<&'static mut UsbMass> {
    unsafe { MASS0.as_mut() }
}
